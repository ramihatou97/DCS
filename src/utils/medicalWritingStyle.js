 ...
 */
export function applyMedicalWritingStyle(text, section = 'hospitalCourse', options = {}) {
  if (!text) return '';
 ...
 */
export function convertToPastTense(text) {
 ...
 */
export function convertToPresentTense(text) {
 ...
 */
export function convertToFutureTense(text) {
 ...
 */
export function validateMedicalWritingStyle(text, section = 'hospitalCourse') {
  const issues = [];

 ...
 */
export function generatePrognosisTemplate(extracted, intelligence = null) {
 ...
 */
export function generateProceduresTemplate(extracted) {
 ...
 */
export function generateChiefComplaintTemplate(extracted) {
 ...
 */
export function generateHospitalCourseTemplate(extracted) {
 ...
 */
export function isSectionAdequate(section) {
 ...
 */
export function getTemplateFunction(sectionName) {
  const templates = {

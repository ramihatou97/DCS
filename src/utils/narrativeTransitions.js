 ...
 */
export function selectTransition(previousSentence, nextSentence, context = {}) {
  try {
 ...
 */
export function buildNarrativeWithTransitions(sentences, context = {}) {
 ...
 */
export function getTransitionPhrase(type, subtype = null) {
  try {

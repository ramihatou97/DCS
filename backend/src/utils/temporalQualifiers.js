 ...
 */
const categorizeByTemporalContext = (extractedItems, sourceText) => {
  const categorized = {
    PAST: [],
    PRESENT: [],
    FUTURE: [],
 ...
 */
const isHistoricalFinding = (finding, text) => {
 ...
 */
const enrichEventsWithTemporalContext = (events, sourceText) => {
 ...
 */
const filterActiveComplications = (complications, sourceText) => {
 ...
 */
const separateBaselineAndDischarge = (extractedData, sourceText) => {
  const result = {
    baseline: {},
    discharge: {},
    unclear: {}

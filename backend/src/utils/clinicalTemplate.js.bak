...
import { formatDate, calculateDaysBetween } from './dateUtils.js';
 ...
 */
export const CLINICAL_TEMPLATE = `Neurosurgery Discharge Summary
@TD@
Admitting Diagnosis
@ADMITDX@  
 ...
 */
export function generateClinicalTemplateFormat(extractedData, narrative = {}) {
  if (!extractedData) {

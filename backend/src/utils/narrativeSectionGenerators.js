...
} = require('./specificNarrativeGenerators.js');

/**
 * Generate demographics section with all required fields
 */
function generateDemographicsSection(extractedData) {
 ...
 */
function generateAdmissionDateSection(extractedData) {
 ...
 */
function generateDischargeDateSection(extractedData) {
 ...
 */
function generatePrimaryDiagnosisSection(extractedData) {
 ...
 */
function generateHospitalCourseSection(extractedData) {
  const events = [];
 ...
 */
function generateProceduresSection(extractedData) {
 ...
 */
function generateMedicationsSection(extractedData) {
 ...
 */
function generateDischargeDispositionSection(extractedData) {
 ...
 */
function generateFollowUpSection(extractedData) {
 ...
 */
function generatePresentingSymptomsSection(extractedData) {
 ...
 */
function generateComplicationsSection(extractedData) {
 ...
 */
function generatePhysicalExamSection(extractedData) {
 ...
 */
function generateConsultationsSection(extractedData) {
 ...
 */
function generateImagingSection(extractedData) {
 ...
 */
function generateLabsSection(extractedData) {
 ...
 */
function ensureAllSectionsGenerated(narrative, extractedData) {

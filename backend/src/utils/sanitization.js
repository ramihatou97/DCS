 ...
 */
const validateNoExtrapolation = (text) => {
 ...
 */
const validateAgainstSource = (extracted, sourceText, threshold = 0.5) => {
 ...
 */
const validateMedicalTerms = (text) => {
  const warnings = [];
 ...
 */
const validatePathologyRequirements = (pathology, data) => {
  const requirements = {
...
module.exports = {
  ...
  validateNoExtrapolation,
  validateAgainstSource,
  validateMedicalTerms,
  validatePathologyRequirements,
  sanitizeInput
};

 ...
 */
export function generateSpecificComplicationsNarrative(data) {
 ...
 */
export function generateSpecificProceduresNarrative(data) {
 ...
 */
export function generateSpecificMedicationsNarrative(data) {
 ...
 */
export function generateSpecificFollowUpNarrative(data) {
 ...
 */
export function generateSpecificLabsNarrative(data) {
 ...
 */
export function generateSpecificImagingNarrative(data) {
 ...
 */
export function generateSpecificConsultationsNarrative(data) {
 ...
 */
export function replaceVagueQuantifiers(text) {
  if (!text) return text;
